...
export const SpanishExercise = () => {
  ...
  async function presion(e) {
    ...
    const respuesta = await SpanishExerciseIA(mensaje);
        ...
        <form onSubmit={presion} id="principalForm" className="p-6 sm:p-8 shadow-2xl w-full lg:w-96 flex flex-col gap-6" style={{backgroundColor: 'var(--edu-lightest)'}}>
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-xl font-bold" style={{color: 'var(--edu-darkest)'}}>Español</h3>
            </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                style={{backgroundColor: 'rgba(74, 102, 77, 0.5)', color: 'var(--edu-darkest)', caretColor: 'var(--edu-darkest)'}}
                placeholder="Ej. Gramática, Ortografía, Redacción..."
              />
            </div>
            <div className="flex flex-col gap-2">
          ...
          <div className="mt-auto pt-6 border-t flex items-center gap-3" style={{borderColor: 'rgba(74, 102, 77, 0.2)'}}>
            ...
            <p className="text-[10px] leading-tight" style={{color: 'var(--edu-mid)'}}>
              La IA adapta el contenido al estilo de español seleccionado.
            </p>
          </div>
        </form>
          ...
          <div className="max-w-4xl mx-auto flex flex-col gap-6 h-full overflow-y-auto pr-2">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black" style={{color: 'var(--edu-darkest)'}}>Ejercicios de Español</h2>
              </div>
            </div>
                ...
                <>
                  ...
                  {showPdfPreview ? (
                    <div style={{height: '520px'}}>
                      <PDFContent ejercicio={ejercicios} titulo="Ejercicios de Español" preview />
                    </div>
                  ) : (
