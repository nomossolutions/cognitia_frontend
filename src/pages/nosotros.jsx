    ...
    <div className='min-h-screen'>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-16 md:mb-24 flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <h2 className="text-h2-sm sm:text-h2 font-bold mb-4" style={{ color: 'var(--edu-darkest)' }}>
                Nació en el aula
              </h2>
              <div className="w-20 h-1 mb-6" style={{ backgroundColor: 'var(--edu-accent)' }}></div>
              <p className="text-body sm:text-body leading-body" style={{ color: 'var(--edu-dark)' }}>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-body sm:text-body leading-body mb-4" style={{ color: 'var(--edu-dark)' }}>
              ...
              <p className="text-body sm:text-body leading-body font-semibold" style={{ color: 'var(--edu-accent)' }}>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8"
        ...
        <div className="container mx-auto max-w-5xl text-center">
          <h2 className="text-h1-sm sm:text-h1 md:text-hero-sm font-bold mb-4"
            style={{ color: 'var(--edu-lightest)' }}>
            Lo que nos mueve
          </h2>
          <p className="text-body sm:text-h3-sm mb-12" style={{ color: 'var(--edu-light)' }}>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-pattern">
        <div className="container mx-auto max-w-3xl text-center">
          <h2 className="text-h1-sm sm:text-h1 md:text-hero-sm font-bold mb-6"
            style={{ color: 'var(--edu-darkest)' }}>
            ¿Listo para unirte?
          </h2>
          <p className="text-body sm:text-h3-sm mb-8 leading-body"
            style={{ color: 'var(--edu-dark)' }}>
