...
export const ProgrammingExercise = () => {
  ...
  async function presion(e) {
    ...
    const respuesta = await ProgrammingExerciseIA(mensaje);
        ...
        <form onSubmit={presion} id="principalForm" className="p-6 sm:p-8 shadow-2xl w-full lg:w-96 flex flex-col gap-6" style={{backgroundColor: 'var(--edu-lightest)'}}>
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: 'var(--edu-mid)'}}>
                <HiCodeBracket className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-xl font-bold" style={{color: 'var(--edu-darkest)'}}>Programación</h3>
            </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                placeholder="Ej. Algoritmos, POO, Estructuras..."
              />
            </div>
            <div className="flex flex-col gap-2">
              <label htmlFor="lenguaje" className="text-sm font-medium" style={{color: 'var(--edu-darkest)'}}>Lenguaje</label>
              <input 
                type="text" 
                id="lenguaje" 
                className="input-lenguaje w-full px-4 py-3 border-none rounded-xl focus:outline-none focus:ring-2 transition-all text-sm sm:text-base"
                style={{backgroundColor: 'rgba(74, 102, 77, 0.5)', color: 'var(--edu-darkest)', caretColor: 'var(--edu-darkest)'}}
          ...
          <div className="mt-auto pt-6 border-t flex items-center gap-3" style={{borderColor: 'rgba(74, 102, 77, 0.2)'}}>
            ...
            <p className="text-[10px] leading-tight" style={{color: 'var(--edu-mid)'}}>
              La IA genera ejercicios adaptados al lenguaje seleccionado.
            </p>
          </div>
        </form>
          ...
          <div className="max-w-4xl mx-auto flex flex-col gap-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black" style={{color: 'var(--edu-darkest)'}}>Ejercicios de Programación</h2>
              </div>
            </div>
