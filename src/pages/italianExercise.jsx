...
import { HiLanguage, HiSparkles, HiUserGroup, HiAcademicCap, HiBuildingLibrary, HiInformationCircle } from 'react-icons/hi2';
...
export const ItalianExercise = () => {
  ...
  async function presion(e) {
    ...
    const respuesta = await ItalianExerciseIA(mensaje);
        ...
        <form onSubmit={presion} id="principalForm" className="p-6 sm:p-8 shadow-2xl w-full lg:w-96 flex flex-col gap-6" style={{backgroundColor: 'var(--edu-lightest)'}}>
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{backgroundColor: 'var(--edu-mid)'}}>
                <HiLanguage className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-xl font-bold" style={{color: 'var(--edu-darkest)'}}>Italiano</h3>
            </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label htmlFor="region" className="text-sm font-medium" style={{color: 'var(--edu-darkest)'}}>Región/País</label>
              <input 
                type="text" 
                id="region" 
                placeholder="Ej. Italiano estándar, Toscano..." 
                className="input-region w-full px-4 py-3 border-none rounded-xl focus:outline-none focus:ring-2 transition-all text-sm sm:text-base"
            ...
            <div className="flex flex-col gap-2">
              ...
              <input 
                type="text" 
                id="tema" 
                placeholder="Ej. Verbos irregulares, conjugación..." 
          ...
          <div className="mt-auto pt-6 border-t flex items-center gap-3" style={{borderColor: 'rgba(74, 102, 77, 0.2)'}}>
            ...
            <p className="text-[10px] leading-tight" style={{color: 'var(--edu-mid)'}}>
              La IA adapta el contenido al nivel y estilo de italiano seleccionado.
            </p>
          </div>
        </form>
          ...
          <div className="max-w-4xl mx-auto flex flex-col gap-6 h-full overflow-y-auto pr-2">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black" style={{color: 'var(--edu-darkest)'}}>Ejercicios de Italiano</h2>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-soft-xl hover:shadow-float transition-all duration-300 border-none flex flex-col" style={{minHeight: ejercicios ? 'auto' : '400px'}}>
              <div className="flex items-center gap-3 mb-6">
                <HiLanguage className="w-6 h-6" style={{color: 'var(--edu-mid)'}} />
                ...
                <>
                  ...
                  {showPdfPreview ? (
                    <div style={{height: '520px'}}>
                      <PDFContent ejercicio={ejercicios} titulo="Ejercicios de Italiano" preview />
                    </div>
                  ) : (
                    ...
                    <div className="text-center py-12">
                      <div className="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center" style={{backgroundColor: 'rgba(163, 177, 138, 0.1)'}}>
                        <HiLanguage className="w-8 h-8" style={{color: 'var(--edu-light)'}} />
                      </div>
